...
<input type="hidden" id="oldText" value="${param.oldText}">
    ...
    <div class="mid">
    	...
    	<div class="mid2">
			...
			<span class="GBN">홈 > 관리자 페이지 > 회원 관리 > 교직원</span>
    	</div>
    	<div class="mid3">
    		<div class = "mid3_1">교직원 목록</div>
    	</div>
    		...
    		<form action="#" id="searchForm" method="POST">
		    	...
		    	<div class="search_b">
	            	<input type ="text" class="b_txt" name="searchText" id="schText" 
	            	       placeholder="교직원 검색" value="${param.searchText}">
		    	</div>
