...
$(document).ready(function() {
	...
	$("tbody").on("click", "tr td:not(:first-child)", function() {
		...
		$("#searchForm").attr("action", "adminBrdDetail")
		$("#searchForm").submit();
	});
...
<input type="hidden" id="oldText" value="${param.oldText}">
    ...
    <div class="p">
		...
		<span class="GBN">홈 > 관리자 페이지 > 게시판 관리</span><br/>
