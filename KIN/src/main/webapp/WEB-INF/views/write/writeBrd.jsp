...
.brdList tbody tr:hover {
	background-color: #e1e1fb;
}

.brdList tr td:nth-child(2) {
	text-align: left;
	text-indent: 10px;
}
...
<input type="hidden" id="oldText" value="${param.oldText}">
	<div class="p">
		...
		<div class="title">작성한 글</div>
		<span class="GBN">홈 > 마이 페이지 > 작성내역조회 > 작성한 글</span><br/>
		...
		<table class="t empBrdList">
			<thead><tr><th>작성한 글이 존재하지 않습니다.</th></tr></thead>
		</table>
		<table class="t brdList">
			<colgroup> <!-- 전체 1100 -->
				<col width="200" />
				<col width="500" />
				<col width="200" />
