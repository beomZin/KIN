...
public class BatchComponent {
	...
	public void deleteBatchSu() throws Throwable {
		...
		try {
			a = dao.getList("u.batchSu");
			
			if(!a.isEmpty()) {
				dao.delete("u.deleteBatchSu", a);
			}
			
			b = dao.getList("u.batchStaff");
			
			if(!b.isEmpty()) {
				dao.delete("u.deleteBatchStaff", b);
			}
